...
// aulter native to check
   ...
   const user =  await User.findOne({
    ...
    const options = res.cookie("refreshToken", refreshToken, "accessToken", accessToken, {
            httpOnly: true, 
...
const changePassword = asyncHandler(async (req, res) => {
    ...
    if (!ispasswordCorrect) {
        throw new ApiError(401, "Is Password Correct")
    }
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200 , channel[0] ,"User Channel Fatched")
    )        
})
...
const getWatchHistory = asyncHandler(async(req , res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200 , user[0].watchHistory ,"Video count Fatched")
    )
})


export { registerUser, loginUser ,logoutUser ,refreshAccessToken ,getCurrentUser , changePassword ,updateAccountDetails ,updateUserAvatar ,updateUserCoverImage, getUserChannelProfile , getWatchHistory};   